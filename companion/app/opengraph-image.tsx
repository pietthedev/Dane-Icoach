      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(75,46,131,0.9) 0%, transparent 70%)",
          }}
        />
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(126,100,181,0.4) 0%, transparent 70%)",
          }}
        />
        ...
        <div
          style={{
            width: 280,
            height: 1,
            background: "rgba(126,100,181,0.5)",
            marginBottom: 32,
          }}
        />
